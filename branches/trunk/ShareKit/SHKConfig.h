...
#define SHKMyAppName			@"Stix"
#define SHKMyAppURL				@"http://stixmobile.com"
...
#define SHKFacebookKey				@"191699640937330"
#define SHKFacebookSecret			@"0160a0bdd2284a610a39590c117167f6"
 ...
 */
#define SHKTwitterConsumerKey		@"VwXbDvMflzcj6NSwo6NtA"
#define SHKTwitterSecret			@"sU8OFkq08sU9s4g6BKRVpnXgI9iqsfzWSlHYRTxyo"
#define SHKTwitterCallbackUrl		@"None" // You need to set this if using OAuth, see note above (xAuth users can skip it)
